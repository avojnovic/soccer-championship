namespace SoccerChampionship
{
    ...
    public partial class App : Application
    {
        ...
        {
            var ex = GetInnerestException(e.ExceptionObject);

            ErrorWindow.CreateNew(GetInnerestException(e.ExceptionObject));
        ...
        private Exception GetInnerestException(Exception ex)
        {
            if (ex.InnerException != null)
                return GetInnerestException(ex.InnerException);
            else
                return ex;

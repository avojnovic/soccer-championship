...
INSERT [Team] ([ID], [Name], [CategoryID]) VALUES (1, N'LosPajas', 1)
INSERT [Team] ([ID], [Name], [CategoryID]) VALUES (2, N'LosVerGotas', 2)
SET IDENTITY_INSERT [Team] OFF
SET IDENTITY_INSERT [Player] ON
INSERT [Player] ([ID], [Dni], [Mail], [Name], [Address], [Phone], [TeamID]) VALUES (1, 32145166, N'damionly@gmail.com', N'Damian Barletta fg', N'Zabala 2710', N'46248252', 2)
...
INSERT [Player] ([ID], [Dni], [Mail], [Name], [Address], [Phone], [TeamID]) VALUES (3, 32403832, N'nue.g@gmail.com', N'Nuelio Gimenezfg', N'Libertad 222', N'49897796', 2)
